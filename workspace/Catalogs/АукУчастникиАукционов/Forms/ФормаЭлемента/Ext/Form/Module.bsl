...
Процедура ДобавитьВсеВидыАукционовВСписок()
	...
	масВидыАукционов = АукОбщийВызовСервера.ВидыАукционовСписком();
	
	АукОбщийКлиент.ЗаполнитьТаблицуДаннымиМассиваСтруктур(Объект.ВидыАукционов, масВидыАукционов, "ВидАукциона");
...
Процедура ПередЗаписьюПриСозданииКонтактногоЛица(Результат, ДополнительныеПараметры) Экспорт
	...
	Если Результат = КодВозвратаДиалога.Да Тогда	
		...
		Если ПроверитьЗаполнение() Тогда
			...
			ОткрытьФорму("Справочник.АукКонтактныеЛицаУчастниковАукционов.ФормаОбъекта", ПараметрыФормы,
...
Процедура ПередЗаписьюПриВыбореКонтактногоЛица(Результат, ДополнительныеПараметры) Экспорт
	...
	Если Результат = КодВозвратаДиалога.Да Тогда	
		...
		Если ПроверитьЗаполнение() Тогда
			...
			ОткрытьФорму("Справочник.АукКонтактныеЛицаУчастниковАукционов.ФормаВыбора", ПараметрыФормы,
							ДополнительныеПараметры.Элемент,,,, Оповещение, РежимОткрытияОкнаФормы.БлокироватьОкноВладельца); 
...
Процедура УдалитьКонтактныхЛицПоВидуАукциона(пВидАукциона)
	АукОбщийКлиентСервер.УдалитьСтрокиТаблицыПоСтруктуреОтборов(Объект.КонтактныеЛица, Новый Структура("ВидАукциона", пВидАукциона)); 	
КонецПроцедуры
